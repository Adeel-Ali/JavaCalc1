...
import io.apimatic.examples.controllers.CalculatorEndpoints;

import com.fasterxml.jackson.core.type.TypeReference;

public class CalculatorEndpointsTest extends ControllerTestBase {
    
    /**
     * Controller instance (for all tests)
     */
    private static CalculatorEndpoints controller;
    ...
    public static void setUpClass() {
        controller = getClient().getCalculatorEndpoints();
    }
