...
public class CalculatorEndpoints extends BaseController {
    //private static variables for the singleton pattern
    private static final Object syncObject = new Object();
    private static CalculatorEndpoints instance = null;

    /**
     * Singleton pattern implementation 
     * @return The singleton instance of the CalculatorEndpoints class 
     */
    public static CalculatorEndpoints getInstance() {
        if (null == instance) {
            synchronized (syncObject) {
                if (null == instance) {
                    instance = new CalculatorEndpoints();
                }
            }
        }
        return instance;
